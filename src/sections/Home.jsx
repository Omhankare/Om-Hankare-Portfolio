...
import resume from "../assets/omHankareResume.pdf";
  ...
  return (
    ...
    >
      <div className="text-center z-10 px-4">
        <img
          className="w-[200px] border-0 mt-20 rounded-full shadow-lg shadow-gray-500/70 
      ...
      <div className="text-center font-mono z-10 px-4">
        <h1
          className="text-4xl md:text-5xl lg:text-6xl lg:max-w[500px] font-semibold mb-6 px-1 
        ...
        <p className="text-gray-300 text-lg mb-8 max-w-lg mx-auto">
          ...
          creating clean, user-friendly digital experiences that make a real
          impact
        </p>
        ...
        <div className="flex justify-center items-center space-x-4">
          <a
            ...
            hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] font-medium transition relative overflow-hidden"
            href="#contact"
          >
            Contact Me
          </a>
